...
async function fixTypebotSchema() {
  ...
  try {
    ...
    console.log('🎉 =========================================================================');
    console.log('✅ ESQUEMA TYPEBOT CORREGIDO Y PUBLICADO CON ÉXITO');
    console.log('🎉 =========================================================================');
    console.log(`📌 Typebot ID       : ${typebotId}`);
    console.log(`🔗 Enlace Editor UI  : https://bot.jgispublicidad.pe/typebot/typebots/${typebotId}/edit`);
    console.log('=========================================================================\n');

  } catch (err) {
    console.error('❌ Error reparando esquema Typebot:', err.message);
  } finally {
    await pool.end();
  }
}
